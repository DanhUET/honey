const textConfig = {
    text1: "Em yêu ơi!",
    text2: "Anh có điều này muốn hỏi cậu nhớ phải trả lời thật lòng nhaaaaa.",
    text3: "Sau này làm vợ anh nhé ._.",
        ...
        Swal.fire({
            ...
            if (result.value) {
                Swal.fire({
                    ...
                    onClose: () => {
                        // window.location.href = "lovely/cart.html";
                        window.location.href =
                            " https://danhuet.github.io/Happy_birthday/";
                    },
                });
            }
        });
